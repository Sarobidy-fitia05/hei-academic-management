...
public class GraduationService {
    ...
    public List<GraduateDTO> generate(
            Integer promotionYear, ProgramCode programCode, Integer graduationYear, List<GraduateDTO> rawGraduates)
            throws IOException {
        Promotion promotion = promotionRepository.findByYear(promotionYear)
    ...
    public File downloadXlsx(UUID graduationListId) {
        Document document = documentRepository.findByGraduationListId(graduationListId)
                .stream()
                .findFirst()
    ...
    private List<GraduateDTO> rank(List<GraduateDTO> rawGraduates) {
        List<GraduateDTO> sorted = rawGraduates.stream()
